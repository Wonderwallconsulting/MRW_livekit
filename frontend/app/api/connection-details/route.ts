...
export async function GET() {
  try {
    ...
    await createExplicitDispatch(roomName, "inbound-agent");
...
// Function to dispatch the agent to the room

async function createExplicitDispatch(roomName: string, agentName: string) {
